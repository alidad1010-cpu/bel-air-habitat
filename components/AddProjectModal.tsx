...
const AddProjectModal: React.FC<AddProjectModalProps> = ({ isOpen, onClose, onAdd, initialClient, clients = [], projects = [] }) => {
  ...
  const inputClass = "w-full p-2.5 bg-white dark:bg-slate-900 dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-emerald-500 outline-none transition-all text-base md:text-sm text-slate-800 dark:text-slate-100 dark:text-white dark:text-white placeholder-slate-400";
  const labelClass = "block text-xs font-bold text-slate-700 dark:text-slate-200 dark:text-white dark:text-white dark:text-white uppercase mb-1 ml-1";
