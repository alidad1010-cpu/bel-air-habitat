...
import { getFirestore, collection, doc, setDoc, deleteDoc, onSnapshot, query, enableIndexedDbPersistence, where, orderBy, limit } from "firebase/firestore";
export { where, orderBy, limit, query, collection };
import { getStorage, ref, uploadBytes, getDownloadURL } from "firebase/storage";
import { getAuth, signInWithEmailAndPassword, createUserWithEmailAndPassword, signOut, onAuthStateChanged, User as FirebaseUser, setPersistence, browserSessionPersistence } from "firebase/auth";
...
const firebaseConfig = {
    ...
    storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || "bel-air-habitat.firebasestorage.app",
